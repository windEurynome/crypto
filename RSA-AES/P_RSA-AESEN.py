...
#with open('E:/plaintext.txt','r',encoding='utf-8') as f:
#    chinese = f.read()
#print (chinese)
...
def test():
    ...
    print("***********************AES-128***********************")
    print("***********************RSA密文***********************")
    with open('E:/p_keyde.txt','r',encoding='utf-8') as f:
        key = f.read()
    #print(key)
