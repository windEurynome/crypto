...
def test():
    ...
    for KEYS in str1:
        ...
        #print(message)
        #print(type(message)) 
        f = open('E:/0000桌面需要小文件/grade3/密码学课程设计/p_decrypto.txt','a',encoding='utf-8')
    ...
    # hex->bytes->base64；
    with open('E:/0000桌面需要小文件/grade3/密码学课程设计/p_decrypto.txt','r',encoding='utf-8') as f:
        hexStr = f.read()
    #hexStr=s_b
    ...
    print('\n')
    print("************************解密**************************")
    print("进制转换后生成图片message.jpg。")
    with open('E:/0000桌面需要小文件/grade3/密码学课程设计/message.jpg','wb') as f:
    #can change the file path,'a'means to continue the last ones
        f.write(pic)
    #print(f)
