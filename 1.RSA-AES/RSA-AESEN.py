...
def test():
    ...
    print('\n')
    print("AES密钥已加密存放到keyde.txt中。")
    str1=binascii.hexlify(str)
    f = open('E:/0000桌面需要小文件/grade3/密码学课程设计/keyde.txt','a')
    ...
    print('\n')
    print('解密后明文：')
    f = open('E:/0000桌面需要小文件/grade3/密码学课程设计/key.txt','a')
    ...
    #print('\n')
    print("***********************RSA密文***********************")
    with open('E:/0000桌面需要小文件/grade3/密码学课程设计/keyde.txt','r',encoding='utf-8') as f:
        key = f.read()
    #print(key)
    print("从keyde.txt读取被加密的AES密钥。")
    print('\n')
    print("************************密文**************************")
    #print("PLAINTEXT:        %s" % binascii.hexlify(plaintext))
    #print("KEY:              %s" % binascii.hexlify(key128))
    print("密文存放在encrypto.txt中。")
    ...
    for KEYS in string1:
        ...
        f = open('E:/0000桌面需要小文件/grade3/密码学课程设计/encrypto.txt','a')
        #can change the file path,'a'means to continue the last ones
        print(bytesToString(cipher),end='',file = f)
        #print(bytesToString(cipher),end='')
        f.close()
        #print("密文已经存放在encrypto.txt中。")
